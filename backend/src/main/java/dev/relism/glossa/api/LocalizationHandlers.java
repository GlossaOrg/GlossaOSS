...
public final class LocalizationHandlers {
    ...
    /** Every route here works through LocalizationService; one that also reads a body extends {@link Body}. */
    private abstract static class Base extends RequestHandler { @Inject protected LocalizationService content; }
    private abstract static class Body<B> extends JsonHandler<B> { @Inject protected LocalizationService content; }
    ...
    @ApiOperation(summary = "The project's locales.",
                  ...
                  tags = "Localization")
    public static final class Locales extends Base {
        @Override public List<Localization.LocaleView> handle(Request req, Response res) {
    ...
    public static final class ConfigureLocale extends Body<LocaleConfig> {
    ...
    public static final class RemoveLocale extends Base {
    ...
    public static final class Resources extends Base {
        @Override public List<Localization.ResourceView> handle(Request req, Response res) {
    ...
    public static final class CreateResource extends Body<Localization.CreateResource> {
    ...
    public static final class Detail extends Base {
        @Override public Localization.Detail handle(Request req, Response res) {
    ...
    @ApiOperation(summary = "Writes a revision.",
                  ...
                  tags = "Localization")
    public static final class Edit extends Body<Localization.Edit> {
    ...
    public static final class Review extends Body<Decision> {
    ...
    @ApiOperation(summary = "Reverts to an earlier revision.",
                  ...
                  tags = "Localization")
    public static final class Revert extends Body<Localization.Revert> {
    ...
    public static final class Archive extends Body<Archived> {
    ...
    @ApiOperation(summary = "Renders the approved value.",
                  ...
                  tags = "Localization")
    public static final class Render extends Body<Values> {
    ...
    @ApiOperation(summary = "Checks a message.",
                  ...
                  tags = "Localization")
    public static final class Analyze extends Body<MessageRequest> {
    ...
    public static final class Preview extends Body<MessageRequest> {
    ...
    @ApiOperation(summary = "Suggests a translation.",
                  ...
                  tags = "Localization")
    public static final class Translate extends Body<Suggest> {
    ...
    public static final class Publish extends Base {
        @Override public Localization.ReleaseView handle(Request req, Response res) {
            res.status(201);
    ...
    @ApiOperation(summary = "The current release's hash.",
                  ...
                  tags = "Delivery")
    public static final class Manifest extends Base {
        @Override public Localization.ReleaseView handle(Request req, Response res) {
    ...
    public static final class Catalog extends Base {
        @Override public Object handle(Request req, Response res) {
